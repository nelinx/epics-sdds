...
#define SET_REPEAT 3
#define SET_MAJOR_ORDER 4
#define N_OPTIONS 5

char *option[N_OPTIONS] = {
  "pipe", "define", "sequence", "repeat", "majorOrder",
};
...
[-sequence=[begin=<value>][,number=<integer>][,end=<value>][,delta=<value>][,interval=<integer>]...] [-majorOrder=row|column] \n\n\
...
void setupOutputFile(SDDS_DATASET *outputTable, char *output,
                     DEFINITION *definition, long definitions, short columnMajorOrder);
