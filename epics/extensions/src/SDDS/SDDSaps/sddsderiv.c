...
[-errorTemplates=<item>=<string>[,...]] [-majorOrder=row|column] \n\n\
...
static char *option[CLO_OPTIONS] = {
    ...
    "pipe", "exclude", "savitzkygolay", "majorOrder",
    };
...
long setupOutputFile(SDDS_DATASET *SDDSout, SDDS_DATASET *SDDSin, char *output,
                     ...
                     char **mainTemplate, char **errorTemplate, int32_t interval, long order, short columnMajorOrder);
...
int main(int argc, char **argv)
{
    ...
    setupOutputFile(&SDDSout, &SDDSin, output, &yOutputName, &yOutputErrorName, &yOutputUnits,
                    ...
                    interval, SGOrder>=0?SGDerivOrder:1, columnMajorOrder);
...
long setupOutputFile(SDDS_DATASET *SDDSout, SDDS_DATASET *SDDSin, char *output,
                     ...
                     long order, short columnMajorOrder)
{
    long i;
