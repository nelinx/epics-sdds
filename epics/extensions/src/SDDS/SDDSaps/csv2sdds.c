...
char *option[N_OPTIONS] = {
  ...
  "pipe", "spanlines", "maxrows","skiplines","uselabels", "majorOrder",
};
...
void SetUpOutputFile(SDDS_DATASET *SDDSout, char *input, char *output, 
                     COLUMN_DATA *columnData, long columns, long asciiOutput, short columnMajorOrder);
...
void SetUpOutputFile(SDDS_DATASET *SDDSout, char *input, char *output, COLUMN_DATA *columnData,
                     long columns, long asciiOutput, short columnMajorOrder)
{
  char s[10240];
  long i;
