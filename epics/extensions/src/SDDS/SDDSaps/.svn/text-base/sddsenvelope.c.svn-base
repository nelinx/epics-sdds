...
char *option[N_OPTIONS] = {
  ...
  "signedlargest", "pmaximum", "pminimum", "majorOrder",
  } ;
...
long setupOutputFile(SDDS_DATASET *outTable, char *output, SDDS_DATASET *inTable, 
                     STAT_DEFINITION *stat, long stats, long rows, short columnMajorOrder);
...
static char *USAGE="sddsenvelope [<input>] [<output>] [-copy=<column-names>] \n\
  ...
  [-wsigma=<weightColumn>,<columnNames>] [-majorOrder=row|column] \n\n\
