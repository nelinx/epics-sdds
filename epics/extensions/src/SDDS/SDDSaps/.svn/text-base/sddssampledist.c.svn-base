...
#define CLO_OPTIONS 10

static char *option[CLO_OPTIONS] = {
  "pipe", "columns", "samples", "seed", "verbose", "gaussian", "uniform", "poisson", "optimalHalton", "majorOrder",
    } ;
...
[-poisson=columnName=<columnName>[,meanValue=<value>|@<parameter_name>][,units=<string>] [-optimalHalton] [-majorOrder=row|column] \n";
...
-majorOrder     Specifies the output file in row or column major order.\n\
