...
[-lowerLimit=<value>[,...]] [-upperLimit=<value>[,...]] [-cdf=[only]] [-majorOrder=row|column]\n\n\
...
void SetUpOutput(SDDS_DATASET *SDDSout, SDDS_DATASET *SDDSin, long **abscissaIndex,long **cdfIndex,
                 ...
                 char **abscissaName, long abscissaNames, short columnMajorOrder);
...
int main(int argc, char **argv)
{
  ...
  SetUpOutput(&SDDSout, &SDDSin, &abscissaIndex,&cdfIndex, &histogramIndex,
              output, columnName, columnNames, abscissaName, abscissaNames, columnMajorOrder);
