...
char *option[N_OPTIONS] = {
  ...
  "fitlabelformat", "pipe", "evaluate", "autooffset", "copyparameters", "majorOrder",
};
...
-majorOrder            speficy output file in row or column major order.\n\
    ...
    if (s_arg[iArg].arg_type==OPTION) {
      ...
      case CLO_MAJOR_ORDER:
        ...
        if (s_arg[iArg].n_items>0 &&
            (!scanItemList(&majorOrderFlag, s_arg[iArg].list+1, &s_arg[iArg].n_items, 0,
