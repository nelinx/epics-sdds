...
char *option[N_OPTIONS] = {
    ...
    "replaceonly", "maximumlimit", "minimumlimit", "majorOrder",
    };
...
[-chanceLimit=<minimumChance>] [-passes=<number>] [-invert] [-majorOrder] \n\
[{-markOnly | \n\
...
-majorOrer             Specify output file in row or column major order.\n\n\
...
int main(int argc, char **argv)
{
  ...
  unsigned long pipeFlags, tmpFlags, majorOrderFlag;
