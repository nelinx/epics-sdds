...
char *option[N_OPTIONS] = {
  ...
  "changeof", "rowlimit", "pipe", "matchto", "majorOrder",
} ;
...
char *USAGE = "sddsbreak [-pipe=[input][,output]] [<inputfile>] [<outputfile>]\n\
 ...
 -rowlimit=<integer>[,overlap=<integer>] [-majorOrder=row|column] \n\n\
...
int main(int argc, char **argv)
{
  ...
  unsigned long flags, pipeFlags, changeFlags, majorOrderFlag;
  char **stringData;
