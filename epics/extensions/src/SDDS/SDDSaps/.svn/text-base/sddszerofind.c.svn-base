...
#define CLO_OFFSET 4
#define CLO_MAJOR_ORDER 5
#define N_OPTIONS 6

char *option[N_OPTIONS] = {
  "pipe", "columns", "slopeoutput", "zeroesof", "offset", "majorOrder",
    };

static char *USAGE="sddszerofind [<inputfile>] [<outputfile>] [-pipe=[input][,output]] \n\
-zeroesOf=<columnName> [-columns=<columnNames>] [-offset=<value>] [-slopeOutput] [-majorOrder=row|column] \n\n\
