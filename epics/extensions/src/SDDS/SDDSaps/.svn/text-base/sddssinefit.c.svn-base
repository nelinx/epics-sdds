...
[-guess=[constant=<constant>][,factor=<factor>][,frequency=<freq>][,phase=<phase>]] [-majorOrder=row|column] \n\n\
...
void setupOutputFile(SDDS_DATASET *OutputTable, 
                     ...
                     char *output, long fullOutput, SDDS_DATASET *InputTable, char *xName, char *yName, short columnMajorOrder);
...
int main(int argc, char **argv)
{
    ...
    setupOutputFile(&OutputTable, &xIndex, &yIndex, &fitIndex, &residualIndex, output, fullOutput,
                    &InputTable, xName, yName, columnMajorOrder);
