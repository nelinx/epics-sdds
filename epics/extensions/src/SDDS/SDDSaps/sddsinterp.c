...
#define CLO_MAJOR_ORDER 16
#define CLO_OPTIONS 17
...
char *option[CLO_OPTIONS] = {
  ...
  "exclude", "forcemonotonic", "fillin", "equispaced", "interpShort", "majorOrder",
};
...
static char *USAGE = "sddsinterp [<inputfile>] [<outputfile>] [-pipe=[input][,output]]\n\
 ...
 [-aboveRange={value=<value>|skip|saturate|extrapolate|wrap}[,{abort|warn}]] [-majorOrder=row|column]\n\
