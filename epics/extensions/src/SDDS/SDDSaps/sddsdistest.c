...
void compareToDistribution(char *output, long testCode, SDDS_DATASET *SDDSin, char **columnName,  
                           char **sigmaName, long columnNames, long distCode, long degreesFree, char *dofParameter, short columnMajorOrder);
...
-gaussian | -poisson | -student | -chisquared}] [-majorOrder=row|column] \n\n\
...
#define CLO_MAJOR_ORDER 10
#define N_CL_OPTIONS 11

static char *option[N_CL_OPTIONS] = {
    "pipe", "column", "test", "filedistribution", "gaussian",
    "poisson", "student", "chisquared", "degreesoffreedom", "exclude", "majorOrder",
    };
