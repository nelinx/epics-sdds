...
char *option[N_OPTIONS] = {
  "epoch", "pipe", "breakdown", "majorOrder",
} ;

char *USAGE = "sddstimeconvert [<SDDSinput>] [<SDDSoutput>] [-pipe=[input][,output]] [-majorOrder=row|column]\n\
...
-majorOrder speficy output file in row or column major.\n\n\
...
void InitializeOutput(SDDS_DATASET *SDDSout, char *outputfile, TIME_CONVERSION *conversion,
                      long conversions, SDDS_DATASET *SDDSin, short columnMajorOrder);
