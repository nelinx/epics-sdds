...
char *option[N_OPTIONS] = {"push","add","subtract","scalarmultiply","scalardivide",
                           "transpose","invert","multiply","identity","pipe","negation", "verbose","divide","swap", "columnNames", "determinant", "root", "digits", "printPackage", "majorOrder",} ;
...
[-columnNames=filename=<file>[,column=<column>]] [-determinant] [-printPackage] [-majorOrder=row|column] \n\
