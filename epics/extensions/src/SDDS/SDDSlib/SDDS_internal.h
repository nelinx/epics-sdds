...
char *fgetsLZMASkipComments(char *s, int32_t slen, struct lzmafile* lzmafp, char skip_char);
char *fgetsLZMASkipCommentsResize(char **s, int32_t *slen, struct lzmafile* lzmafp, char skip_char);
...
extern int32_t SDDS_ReadBinaryColumns(SDDS_DATASET *SDDS_dataset);
...
extern int32_t SDDS_LZMAWriteAsciiRow(SDDS_DATASET *SDDS_dataset, int32_t row, struct lzmafile* lzmafp);
#if defined(zLib)
