...
class sddsEditAttributesDialog extends JDialog {
	...
	if ((t > 0) && (t < 9))
	    ...
	    typeButtons[6].setSelected(true);
    }
	...
	typeButtons = new JRadioButton[8];
	typeButtons[0] = new JRadioButton("double");
	typeButtons[1] = new JRadioButton("float");
	typeButtons[2] = new JRadioButton("long");
	typeButtons[3] = new JRadioButton("ulong");
	typeButtons[4] = new JRadioButton("short");
	typeButtons[5] = new JRadioButton("ushort");
	typeButtons[6] = new JRadioButton("string");
	typeButtons[7] = new JRadioButton("character");
