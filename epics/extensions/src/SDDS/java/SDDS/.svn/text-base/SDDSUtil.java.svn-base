...
public class SDDSUtil {
    ...
    public final static int SDDS_ULONG = 4;
    public final static int SDDS_SHORT = 5;
    public final static int SDDS_USHORT = 6;
    public final static int SDDS_STRING = 7;
    public final static int SDDS_CHARACTER = 8;
    public final static int SDDS_NUM_TYPES = 8;
